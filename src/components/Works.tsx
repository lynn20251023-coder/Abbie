  ...
  return (
    <section id="works" className="scroll-mt-24 py-24 text-[var(--ink-900)] md:py-[128px]">
      <div className="container-editorial">
        ...
        {/* Works shows the three B-to-B product case studies as a vertical
            stack of full-width landscape tiles. The AI practice is a
            different genre ("how I work") and lives above in <AiManifesto />.
            PROJECTS still holds the AI entry so /?case=ai stays routable. */}
